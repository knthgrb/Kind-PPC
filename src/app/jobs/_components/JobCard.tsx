  ...
  return (
    <div className="flex flex-col p-4 rounded-2xl bg-white border border-[#E0E6F7] transition-all w-full h-auto">
      ...
      <div className="flex items-center justify-between mt-auto">
        <p>
          <span className="jobPrice text-[#CC0000]">₱{job.salary}</span>
        </p>
        <button
          type="button"
          onClick={onAction}
          className="flex cursor-pointer items-center justify-center py-2 px-4 bg-[#CC0000] text-white rounded-lg text-lg hover:bg-red-700"
        >
          {isAuthor ? (
