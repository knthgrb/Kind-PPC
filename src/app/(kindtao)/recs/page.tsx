import RecsPageClient from "./_components/RecsPageClient";
...
/**
 * Server-side data fetching for Recs page
 ...
 */
export async function getRecsPageData() {
  ...
  try {
    ...
    logger.error("Error fetching recs page data:", error);
    return {
      initialJobs: undefined,
      initialMatches: undefined,
      initialConversations: undefined,
...
export default async function RecsPage() {
  const data = await getRecsPageData();
