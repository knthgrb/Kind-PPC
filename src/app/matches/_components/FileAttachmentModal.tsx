    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative w-full max-w-2xl bg-white rounded-2xl border border-[#DFDFDF] shadow-sm p-6">
        ...
        <div className="flex gap-3 mt-6">
          <button
            onClick={handleClose}
            className="flex-1 h-12 rounded-xl bg-white text-gray-700 border border-gray-300 hover:bg-gray-50 transition disabled:opacity-50 disabled:cursor-not-allowed"
          >
            Cancel
          </button>
          <button
            ...
            className="flex-1 h-12 rounded-xl bg-[#cc0000] text-white hover:bg-red-700 transition disabled:opacity-50 disabled:cursor-not-allowed"
          >
