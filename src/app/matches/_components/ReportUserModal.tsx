        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="mb-5">
            ...
            <textarea
              ...
              className="postJobInputPlaceholder w-full min-h-[160px] rounded-xl border border-[#DFDFDF] px-4 py-3 outline-none resize-y text-sm"
              required
            />
          </div>
          ...
          <div className="flex gap-3">
            <button
              ...
              onClick={handleClose}
              disabled={isLoading}
              className="flex-1 h-12 rounded-xl bg-white text-[#CB0000] border border-[#CB0000] hover:bg-gray-200 transition disabled:opacity-50 disabled:cursor-not-allowed"
            >
              Cancel
            </button>
            ...
            <button
              ...
              className="flex-1 h-12 rounded-xl bg-[#CB0000] text-white hover:bg-[#a30000] transition disabled:opacity-50 disabled:cursor-not-allowed"
            >
