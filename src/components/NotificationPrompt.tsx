          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="mt-3 flex space-x-2">
              <button
                ...
                disabled={isLoading}
                className="inline-flex items-center px-3 py-1.5 border border-transparent text-xs font-medium rounded-md text-white bg-[#cc0000] hover:bg-[#aa0000] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#cc0000] disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {isLoading ? "Enabling..." : "Enable"}
              </button>
              <button
                onClick={handleDismiss}
                className="inline-flex items-center px-3 py-1.5 border border-gray-300 text-xs font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#cc0000]"
              >
                Not now
              </button>
            </div>
