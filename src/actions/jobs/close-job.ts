...
export async function closeJob(
  ...
  try {
    ...
    if (existingJob.kindbossing_user_id !== userId) {
      return { success: false, error: "Unauthorized to close this job" };
    }
    ...
    logger.info("Job closed successfully:", { jobId, userId });
    ...
    return {
      success: false,
      error: err instanceof Error ? err.message : "Failed to close job",
    };
  }
}
